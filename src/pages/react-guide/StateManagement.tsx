        ...
        <div className={styles.container}>
            ...
            <div className={styles.demoSection}>
                ...
                <div style={{ marginTop: '15px' }}>
                    ...
                    React에서는 객체의 속성 하나만 바꾸더라도 전체 객체를 새로 만들어야 리렌더링이 일어납니다.
                    <br />
                    <span className={styles.codeBlock}>setUser(prev {'=>'} (&#123; ...prev, age: prev.age + 1 &#125;))</span>
                    </p>
                </div>
            </div>
            ...
            <div className={styles.demoSection}>
                ...
                <p style={{ fontSize: '0.9em', color: '#666', marginTop: '10px' }}>
                  배열에 항목을 추가할 때도 <span className={styles.codeBlock}>push()</span> 대신 전개 연산자(Spread Operator)를 사용합니다.
                  <br />
